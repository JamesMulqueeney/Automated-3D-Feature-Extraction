...
Internal.Shape <- read.csv("D:/CTData/James Mulqueeney/Papers/Write Up Papers/Paper 1- 3D AI Augmentation Paper/Dice Similarity Coefficient Results/Test Data Results/Internal Mesh Shape/Attempt 2/2023-10-13_Internal_Shape_Comparison_v3.csv")
